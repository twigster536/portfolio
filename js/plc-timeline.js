  ...
  function markup() {
    ...
    container.innerHTML = `
      <div class="plc6-scroll-track"><section class="plc6-shell" aria-label="PLC and Automation Timeline">
        ...
        <aside class="plc6-right" aria-label="Career milestones"><ol>${[{ icon: "&#8984;", year: "2020", copy: "Introduction to<br />Robotics Certification" }, { icon: "&#8680;", year: "2023", copy: "Web Security &amp;<br />Networking" }, { icon: "&#9635;", year: "2024", copy: "Begin PLC with<br />4 Languages" }, { icon: "&#9673;", year: "2025", copy: "AI-Based HVAC<br />Capstone Project" }, { icon: "AI", year: "2026", copy: "Gas 3 Certification<br />In Progress" }, { icon: "&#8734;", year: "FUTURE", copy: "Gas 2 Certification" }].map((item, index) => `<li${index === 0 ? " class=\"is-active\"" : ""}><span class="plc6-node" aria-hidden="true"><span class="plc6-node-ring plc6-node-ring--one"></span><span class="plc6-node-ring plc6-node-ring--two"></span><span class="plc6-node-ring plc6-node-ring--three"></span><i class="plc6-node-icon">${item.icon}</i></span><span class="plc6-node-copy"><b>${item.year}</b><em>${item.copy}</em></span></li>`).join("")}</ol></aside>
