...
window.PortfolioNavigation = (() => {
  ...
  function renderContent(key) { renderHeader(key); if (key === "projects") renderProjects(); else if (key === "resume") renderResume(); else if (key === "memory") renderMemoryWall(); else if (key === "entertainment") renderEntertainment(); else if (key === "recent") renderRecent(); else if (key === "diagnostics") renderDiagnostics(); else renderPlaceholder(key); }
